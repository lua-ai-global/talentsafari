...
class TTS extends import_agents.tts.TTS {
  ...
  constructor(opts = defaultTTSOptions) {
    ...
    if (this.#opts.apiKey === void 0 && !this.#opts.client) {
  ...
  synthesize(text, connOptions, abortSignal) {
    const signal = abortSignal ? AbortSignal.any([abortSignal, this.abortController.signal]) : this.abortController.signal;
