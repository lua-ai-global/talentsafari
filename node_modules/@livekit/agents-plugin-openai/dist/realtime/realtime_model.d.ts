...
export declare class RealtimeModel extends llm.RealtimeModel {
     ...
     */
    static withAzure({ azureDeployment, azureEndpoint, apiVersion, apiKey, entraToken, baseURL, voice, temperature, // eslint-disable-line @typescript-eslint/no-unused-vars
    inputAudioTranscription, inputAudioNoiseReduction, turnDetection, speed, tracing, }: {
        azureDeployment: string;
...
export declare class RealtimeSession extends llm.RealtimeSession {
    ...
    private handleResponseTextDelta;
...
export declare function livekitItemToOpenAIItem(item: llm.ChatItem): Promise<api_proto.ItemResource>;
export {};
