 ...
 * debugging.
 */
export declare const ATTR_PROVIDER_REQUEST_IDS = "lk.provider_request_ids";
...
export declare const ATTR_AMD_CATEGORY = "lk.amd.category";
export declare const ATTR_AMD_REASON = "lk.amd.reason";
export declare const ATTR_AMD_IS_MACHINE = "lk.amd.is_machine";
export declare const ATTR_AMD_INTERRUPT_ON_MACHINE = "lk.amd.interrupt_on_machine";
/** Total user-speech duration captured before the AMD verdict (milliseconds). */
export declare const ATTR_AMD_SPEECH_DURATION = "lk.amd.speech_duration";
/** Time between speech end and the AMD verdict emission (milliseconds). */
export declare const ATTR_AMD_DELAY = "lk.amd.delay";
export declare const ATTR_AMD_TRANSCRIPT = "lk.amd.transcript";
