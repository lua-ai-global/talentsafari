...
__export(trace_types_exports, {
  ...
  ATTR_AMD_CATEGORY: () => ATTR_AMD_CATEGORY,
  ATTR_AMD_DELAY: () => ATTR_AMD_DELAY,
  ATTR_AMD_INTERRUPT_ON_MACHINE: () => ATTR_AMD_INTERRUPT_ON_MACHINE,
  ATTR_AMD_IS_MACHINE: () => ATTR_AMD_IS_MACHINE,
  ATTR_AMD_REASON: () => ATTR_AMD_REASON,
  ATTR_AMD_SPEECH_DURATION: () => ATTR_AMD_SPEECH_DURATION,
  ATTR_AMD_TRANSCRIPT: () => ATTR_AMD_TRANSCRIPT,
  ...
  ATTR_PROVIDER_REQUEST_IDS: () => ATTR_PROVIDER_REQUEST_IDS,
