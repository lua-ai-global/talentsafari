 ...
 */
export declare function getJobContext<ProcessUserData = Record<string, unknown>>(required?: true): JobContext<ProcessUserData>;
export declare function getJobContext<ProcessUserData = Record<string, unknown>>(required: false): JobContext<ProcessUserData> | undefined;
/**
...
export declare class JobContext<ProcessUserData = Record<string, unknown>> {
    #private;
    /** @internal */
...
export declare class JobProcess<UserData = Record<string, unknown>> {
    #private;
    userData: UserData;
    get pid(): number;
}
