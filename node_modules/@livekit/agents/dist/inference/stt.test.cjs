...
(0, import_vitest.describe)("STT diarization capabilities", () => {
  (0, import_vitest.it)("no diarization by default", () => {
    const stt = makeStt();
    (0, import_vitest.expect)(stt.capabilities.diarization).toBe(false);
  });
  (0, import_vitest.it)("diarization enabled with deepgram diarize option", () => {
    const stt = makeStt({ modelOptions: { diarize: true } });
    (0, import_vitest.expect)(stt.capabilities.diarization).toBe(true);
  });
  (0, import_vitest.it)("diarization disabled with diarize false", () => {
    const stt = makeStt({ modelOptions: { diarize: false } });
    (0, import_vitest.expect)(stt.capabilities.diarization).toBe(false);
  });
  (0, import_vitest.it)("diarization enabled with assemblyai speaker_labels", () => {
    const stt = makeStt({
  ...
  (0, import_vitest.it)("updateOptions toggles diarization capability", () => {
    const stt = makeStt();
    (0, import_vitest.expect)(stt.capabilities.diarization).toBe(false);
    stt.updateOptions({ modelOptions: { diarize: true } });
    (0, import_vitest.expect)(stt.capabilities.diarization).toBe(true);
    stt.updateOptions({ modelOptions: { diarize: false } });
    (0, import_vitest.expect)(stt.capabilities.diarization).toBe(false);
  });
  (0, import_vitest.it)("diarization enabled with xai diarize option", () => {
    const stt = makeStt({
      model: "xai/stt-1",
  ...
  (0, import_vitest.it)("updateOptions preserves unrelated flags when merging", () => {
    const stt = makeStt({ modelOptions: { diarize: true } });
    (0, import_vitest.expect)(stt.capabilities.diarization).toBe(true);
    stt.updateOptions({ modelOptions: { endpointing: 500 } });
    (0, import_vitest.expect)(stt["opts"].modelOptions).toHaveProperty("diarize", true);
    (0, import_vitest.expect)(stt["opts"].modelOptions).toHaveProperty("endpointing", 500);
    (0, import_vitest.expect)(stt.capabilities.diarization).toBe(true);
  });
  (0, import_vitest.it)("updateOptions merges modelOptions on associated streams", () => {
    const stt = makeStt({ modelOptions: { diarize: true } });
    const stream = stt.stream();
    stt.updateOptions({ modelOptions: { endpointing: 500 } });
    (0, import_vitest.expect)(stream["opts"].modelOptions).toHaveProperty("diarize", true);
    (0, import_vitest.expect)(stream["opts"].modelOptions).toHaveProperty("endpointing", 500);
    stream.close();
  });
});
