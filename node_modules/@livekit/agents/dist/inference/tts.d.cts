...
export type InworldModels = 'inworld/inworld-tts-2' | 'inworld/inworld-tts-1.5-max' | 'inworld/inworld-tts-1.5-mini' | 'inworld/inworld-tts-1-max' | 'inworld/inworld-tts-1';
 ...
 */
export declare function hasAlignedTranscript(model: string | undefined, modelOptions: Record<string, unknown> | undefined): boolean;
