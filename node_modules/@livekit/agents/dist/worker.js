...
class PendingAssignment {
  promise = new ThrowsPromise((resolve) => {
...
class AgentServer {
  ...
  constructor(opts) {
    ...
    const healthCheck = () => {
      ...
      if (this.#closed || this.#connecting || !this.#session || this.#session.readyState !== WebSocket.OPEN) {
    ...
    const workerWS = async () => {
      ...
      while (!this.#closed) {
        ...
        try {
          ...
          await new ThrowsPromise((resolve) => setTimeout(resolve, delay * 1e3));
        }
      }
    };
  ...
  async #runWS(ws) {
    ...
    const close = new ThrowsPromise((resolve) => {
