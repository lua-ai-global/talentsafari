...
export declare class Agent<UserData = any> {
    ...
    constructor({ id, instructions, chatCtx, tools, turnDetection, stt, vad, llm, tts, allowInterruptions, turnHandling, minConsecutiveSpeechDelay, useTtsAlignedTranscript, ttsPronunciationMap, }: AgentOptions<UserData>);
...
export declare class AgentTask<ResultT = unknown, UserData = any> extends Agent<UserData> {
    ...
    private started;
    private future;
    private _preserveFunctionCallHistory;
