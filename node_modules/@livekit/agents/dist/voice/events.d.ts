...
import type { AgentHandoffItem, ChatMessage, FunctionCall, FunctionCallOutput, LLM, RealtimeModel, RealtimeModelError } from '../llm/index.js';
...
export declare const createSessionUsageUpdatedEvent: ({ usage, createdAt, }: {
    usage: AgentSessionUsage;
    createdAt?: number;
...
export declare const createConversationItemAddedEvent: (item: ChatMessage | AgentHandoffItem, createdAt?: number) => ConversationItemAddedEvent;
...
export declare const createAgentFalseInterruptionEvent: ({ resumed, createdAt, }: {
    resumed: boolean;
    createdAt?: number;
}) => AgentFalseInterruptionEvent;
export type AgentEvent = UserInputTranscribedEvent | UserStateChangedEvent | AgentStateChangedEvent | MetricsCollectedEvent | SessionUsageUpdatedEvent | ConversationItemAddedEvent | FunctionToolsExecutedEvent | SpeechCreatedEvent | AgentFalseInterruptionEvent | OverlappingSpeechEvent | ErrorEvent | CloseEvent;
