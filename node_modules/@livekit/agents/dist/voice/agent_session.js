...
class AgentSession extends EventEmitter {
  ...
  generateReply(options) {
    ...
    const userMessage = (options == null ? void 0 : options.userInput) instanceof ChatMessage ? options.userInput : (options == null ? void 0 : options.userInput) ? new ChatMessage({
      role: "user",
    ...
    const doGenerateReply = (activity, nextActivity) => {
      ...
      try {
        ...
        const canFallback = nextActivity !== void 0 && isSchedulingPausedError(error);
        if (!canFallback) {
          throw error;
        }
        this.logger.debug(
