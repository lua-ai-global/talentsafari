...
function sessionReportToJSON(report) {
  ...
  return {
    ...
    options: {
      ...
      preemptive_generation: ((_i = options.turnHandling) == null ? void 0 : _i.preemptiveGeneration) ?? {}
    },
    chat_history: report.chatHistory.toJSON({ excludeTimestamp: false }),
    enable_user_data_training: report.enableRecording,
    timestamp: report.timestamp,
    usage: report.modelUsage ? report.modelUsage.map(import_model_usage.filterZeroValues) : null
  };
}
