...
/** @experimental */
export type RemoteSessionEventTypes = 'agent_state_changed' | 'user_state_changed' | 'conversation_item_added' | 'user_input_transcribed' | 'function_tools_executed' | 'overlapping_speech' | 'amd_prediction' | 'session_usage' | 'error';
/** @experimental */
