...
describe("textTransforms.replace", () => {
  ...
  it("applies callable and built-in transforms", async () => {
    ...
    expect(
      await collect(
        applyTextTransforms(streamText("**hello** world! \u{1F600}", 3), [
          "filter_markdown",
          replace({ hello: "hi" }),
          "filter_emoji"
        ])
    ...
    expect(() => applyTextTransforms(streamText("text", 4), ["nonexistent"])).toThrow(
      /Invalid transform/
    );
  });
});
//# sourceMappingURL=text_transforms.test.js.map