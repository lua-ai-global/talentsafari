...
import type { WordTokenizer } from '../../tokenize/index.js';
...
declare class SegmentSynchronizerImpl {
     ...
     */
    private readonly seedFromPushAudio;
    private enabled;
    private textData;
    private audioData;
    private speed;
...
export declare class TranscriptionSynchronizer {
    ...
    private _outputsAttached;
    private closed;
    /** @internal */
    _impl: SegmentSynchronizerImpl;
    /** @internal */
    _audioAttached: boolean;
    /** @internal */
    _textAttached: boolean;
    /** @internal */
    _warnedAsymmetricDetach: boolean;
    private logger;
