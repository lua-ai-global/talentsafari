...
(0, import_vitest.describe)("migrateLegacyOptions", () => {
  (0, import_vitest.it)("should return all defaults when no options are provided", () => {
    ...
    (0, import_vitest.expect)(result.turnHandling).toEqual({
      ...
      preemptiveGeneration: import_preemptive_generation.defaultPreemptiveGenerationOptions
    });
...
(0, import_vitest.describe)("migrateTurnHandling", () => {
  ...
  (0, import_vitest.it)("should map preemptiveGeneration boolean to preemptiveGeneration.enabled", () => {
    const resultTrue = (0, import_utils.migrateTurnHandling)({ preemptiveGeneration: true });
    (0, import_vitest.expect)(resultTrue.preemptiveGeneration).toEqual({ enabled: true });
    const resultFalse = (0, import_utils.migrateTurnHandling)({ preemptiveGeneration: false });
    (0, import_vitest.expect)(resultFalse.preemptiveGeneration).toEqual({ enabled: false });
  });
