...
var import_preemptive_generation = require("./preemptive_generation.cjs");
...
function mergeWithDefaults(config) {
  return {
    ...
    preemptiveGeneration: {
      ...import_preemptive_generation.defaultPreemptiveGenerationOptions,
