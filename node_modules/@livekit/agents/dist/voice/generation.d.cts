...
export declare const DEFAULT_TTS_READ_IDLE_TIMEOUT_MS = 10000;
export declare const DEFAULT_FORWARD_AUDIO_IDLE_TIMEOUT_MS = 10000;
/** @internal */
...
export declare const INSTRUCTIONS_MESSAGE_ID = "lk.agent_task.instructions";
/**
 ...
 */
export declare function applyInstructionsModality(chatCtx: ChatContext, options: {
    modality: 'audio' | 'text';
}): void;
...
export declare function performTTSInference(node: TTSNode, text: ReadableStream<string | TimedString>, modelSettings: ModelSettings, controller: AbortController, model?: string, provider?: string, readIdleTimeout?: number, textTransforms?: readonly TextTransform[] | null): [Task<void>, _TTSGenerationData];
...
export declare function performAudioForwarding(ttsStream: ReadableStream<AudioFrame>, audioOutput: AudioOutput, controller: AbortController, idleTimeout?: number): [Task<void>, _AudioOut];
