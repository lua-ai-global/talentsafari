...
class STTPipeline {
  ...
  sttNode;
  _audioChannel = createStreamChannel();
  _eventChannel = createStreamChannel();
  _pumpTask;
  constructor(sttNode) {
...
class AudioRecognition {
  ...
  constructor(opts) {
    ...
    const broadcast = new TransformStream(
      {
    ...
    while (!signal.aborted) {
      ...
      try {
        ...
        forwardTask = (async () => {
          ...
          try {
            while (!signal.aborted) {
              const res = await ThrowsPromise.race([inputReader.read(), abortPromise2]);
              if (!res) break;
