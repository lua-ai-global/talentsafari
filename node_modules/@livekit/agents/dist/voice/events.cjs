...
__export(events_exports, {
  ...
  createAgentFalseInterruptionEvent: () => createAgentFalseInterruptionEvent,
  ...
  createSessionUsageUpdatedEvent: () => createSessionUsageUpdatedEvent,
...
var AgentSessionEventTypes = /* @__PURE__ */ ((AgentSessionEventTypes2) => {
  ...
  AgentSessionEventTypes2["SessionUsageUpdated"] = "session_usage_updated";
  AgentSessionEventTypes2["SpeechCreated"] = "speech_created";
  AgentSessionEventTypes2["AgentFalseInterruption"] = "agent_false_interruption";
  AgentSessionEventTypes2["OverlappingSpeech"] = "overlapping_speech";
...
const createSessionUsageUpdatedEvent = ({
  usage,
  createdAt = Date.now()
}) => ({
