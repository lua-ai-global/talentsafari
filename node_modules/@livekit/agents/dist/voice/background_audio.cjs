...
class BackgroundAudioPlayer {
  ...
  async close() {
    ...
    if (current && current.sid) {
      await ((_c = (_b = this.room) == null ? void 0 : _b.localParticipant) == null ? void 0 : _c.unpublishTrack(current.sid));
    }
  }
  findCurrentPublication() {
    var _a, _b;
    const pubs = (_b = (_a = this.room) == null ? void 0 : _a.localParticipant) == null ? void 0 : _b.trackPublications;
    if (!pubs) return void 0;
  ...
  async publishTrack() {
    ...
    const track = import_rtc_node.LocalAudioTrack.createAudioTrack(BACKGROUND_AUDIO_TRACK_NAME, this.audioSource);
