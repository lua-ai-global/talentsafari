...
(async () => {
  if (process.send) {
    ...
    const runners = await import_throws.ThrowsPromise.all(
    ...
    await import_throws.ThrowsPromise.all(
    ...
    const messageHandler = (msg) => {
      switch (msg.case) {
        ...
        case "shutdownRequest":
          ...
          import_throws.ThrowsPromise.all(Object.values(runners).map((r) => r.close())).then(() => {
