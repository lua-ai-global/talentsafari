...
class PendingInference {
  promise = new import_throws.ThrowsPromise(
    (resolve) => {
...
const startJob = (proc, func, info, closeEvent, logger, joinFuture) => {
  ...
  const task = (async () => {
    ...
    await import_throws.ThrowsPromise.all(shutdownTasks).catch(
