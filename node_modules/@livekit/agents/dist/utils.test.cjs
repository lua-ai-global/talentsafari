...
(0, import_vitest.describe)("utils", () => {
  ...
  (0, import_vitest.describe)("Queue", () => {
    (0, import_vitest.it)("aborts a pending get", async () => {
      const queue = new import_utils.Queue();
      const controller = new AbortController();
      const pending = queue.get({ signal: controller.signal });
      controller.abort();
      await (0, import_vitest.expect)(pending).rejects.toMatchObject({ name: "AbortError" });
    });
  });
  (0, import_vitest.describe)("Task", () => {
    ...
    (0, import_vitest.it)("should timeout if task does not respond to cancellation", async () => {
      ...
      try {
        ...
        (0, import_vitest.expect)(error).instanceof(Error);
        (0, import_vitest.expect)(error.message).toBe("Task cancellation timed out");
      }
    });
  ...
  (0, import_vitest.describe)("dedent", () => {
    (0, import_vitest.it)("should remove common leading indentation", () => {
      const result = import_utils.dedent`
        hello
        world
      `;
      (0, import_vitest.expect)(result).toBe("hello\nworld");
    });
    (0, import_vitest.it)("should preserve relative indentation", () => {
      const result = import_utils.dedent`
        hello
          world
            nested
    ...
    (0, import_vitest.it)("should handle interpolations", () => {
      const name = "world";
      const result = import_utils.dedent`
        hello ${name}
        goodbye ${name}
    ...
    (0, import_vitest.it)("should handle empty lines in the middle", () => {
      const result = import_utils.dedent`
        hello
    ...
    (0, import_vitest.it)("should handle single line", () => {
      const result = import_utils.dedent`
        hello
      `;
      (0, import_vitest.expect)(result).toBe("hello");
    });
    (0, import_vitest.it)("should handle no indentation", () => {
      const result = import_utils.dedent`
hello
world
`;
    ...
    (0, import_vitest.it)("should handle tab indentation", () => {
      const result = import_utils.dedent`
\t\thello
\t\t\tworld
\t\t`;
    ...
    (0, import_vitest.it)("should handle string with only whitespace", () => {
      const result = import_utils.dedent`

      `;
      (0, import_vitest.expect)(result).toBe("");
    });
    (0, import_vitest.it)("should handle inline usage without leading newline", () => {
      const result = import_utils.dedent`hello
        world`;
      (0, import_vitest.expect)(result).toBe("hello\n        world");
    });
    (0, import_vitest.it)("should handle interpolations that span values", () => {
      const a = 1;
      const b = 2;
      const result = import_utils.dedent`
        sum: ${a + b}
        product: ${a * b}
      `;
      (0, import_vitest.expect)(result).toBe("sum: 3\nproduct: 2");
    });
  });
