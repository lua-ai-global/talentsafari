...
export declare const isPending: (promise: Promise<unknown>) => Promise<Throws<boolean, Error>>;
/**
...
/** @internal */
export declare class Future<T = void, E extends Error = Error> {
    #private;
    constructor();
...
/** @internal */
export declare class CancellablePromise<T, E extends Error = Error> {
    #private;
...
export declare class Task<T> {
    ...
    private static readonly currentTaskStorage;
 ...
 */
export declare function isWritableStreamClosedError(error: unknown): boolean;
/**
 ...
 */
export declare function isFfmpegTeardownError(error: unknown): boolean;
/**
 ...
 */
export declare function waitUntilTimeout<T, E extends Error = IdleTimeoutError>(promise: Promise<T>, timeoutMs: number, throwError?: () => E): Promise<Throws<T, E | IdleTimeoutError>>;
/**
...
export declare function waitForTrackPublication({ room, identity, kind, waitForSubscription, signal, }: {
    room: Room;
    /**
 ...
 */
export declare function readStream<T>(stream: ReadableStream<T>, signal?: AbortSignal): AsyncGenerator<T>;
export declare function waitForAbort(signal: AbortSignal): Promise<Throws<void, Error>>;
export declare function rejectOnAbort(signal: AbortSignal): Promise<never>;
/**
...
export declare const isCloud: (url: URL) => boolean;
/**
...
export declare function asError(maybeError: unknown): Error;
/**
