...
__export(openai_exports, {
  toChatCtx: () => toChatCtx,
  toResponsesChatCtx: () => toResponsesChatCtx
});
module.exports = __toCommonJS(openai_exports);
var import_chat_context = require("../chat_context.cjs");
var import_utils = require("../utils.cjs");
var import_utils2 = require("./utils.cjs");
const EXTRA_CONTENT_KEYS = ["google", "livekit", "xai"];
  ...
  if (item.type === "message") {
    ...
    for (const content of item.content) {
      if (typeof content === "string") {
        ...
        textContent += content;
      } else if ((0, import_chat_context.isInstructions)(content)) {
        if (textContent) textContent += "\n";
...
async function toResponsesChatItem(item) {
  if (item.type === "message") {
    ...
    for (const content2 of item.content) {
      ...
      } else if ((0, import_chat_context.isInstructions)(content2)) {
        if (textContent) textContent += "\n";
        textContent += content2.value;
