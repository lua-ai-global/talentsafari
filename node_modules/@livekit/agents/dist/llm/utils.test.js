...
function createSolidColorFrame(width, height, color, bufferType = VideoBufferType.RGBA) {
...
function verifyPngHeader(imageBuffer) {
  ...
  expect(imageBuffer[1]).toBe(80);
  expect(imageBuffer[2]).toBe(78);
  expect(imageBuffer[3]).toBe(71);
}
