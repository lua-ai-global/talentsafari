...
class TTS extends tts.TTS {
  ...
  constructor(opts = {}) {
    ...
    if (this.opts.speed !== void 0 && (this.opts.speed < 0.7 || this.opts.speed > 1.5)) {
  ...
  async run() {
    ...
    try {
      ...
      throw new APIConnectionError({
        message: `Deepgram TTS WebSocket failed: ${e.message ?? "unknown error"}`
      });
    } finally {
