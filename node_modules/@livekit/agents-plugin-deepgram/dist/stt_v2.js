...
function parseTranscription(language, data, startTimeOffset) {
  ...
  const primaryLanguage = detectedLanguages.length > 0 ? detectedLanguages[0] : normalizeLanguage(language);
  const sd = {
...
//# sourceMappingURL=stt_v2.js.map