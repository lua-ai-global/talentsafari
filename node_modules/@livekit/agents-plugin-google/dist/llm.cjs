...
class LLM extends import_agents.llm.LLM {
  ...
  chat({
      ...
      if (typeof toolChoice === "object" && toolChoice.type === "function") {
        geminiToolConfig = {
          functionCallingConfig: {
            mode: import_genai.FunctionCallingConfigMode.ANY,
    ...
    if (this.#opts.serviceTier !== void 0) {
      extras.serviceTier = this.#opts.serviceTier;
    }
    if (this.#opts.mediaResolution !== void 0) {
...
class LLMStream extends import_agents.llm.LLMStream {
  ...
  async run() {
    ...
    try {
      ...
      const functionDeclarations = this.toolCtx ? (0, import_utils.toFunctionDeclarations)(this.toolCtx) : void 0;
      ...
      for await (const chunk of response) {
        ...
        if (((_b = (_a = chunk.candidates) == null ? void 0 : _a[0]) == null ? void 0 : _b.finishReason) && BLOCKED_REASONS.includes(chunk.candidates[0].finishReason)) {
          throw new import_agents.APIStatusError({
        ...
        if (!chunk.candidates || !((_d = (_c = chunk.candidates[0]) == null ? void 0 : _c.content) == null ? void 0 : _d.parts)) {
      ...
      if (error instanceof import_agents.APIStatusError || error instanceof import_agents.APIConnectionError) {
        throw error;
      }
      const err = error;
        ...
        delta: {
          ...
          toolCalls: [
            import_agents.llm.FunctionCall.create({
              callId: part.functionCall.id || (0, import_agents.shortuuid)("function_call_"),
