...
const DEFAULT_MODEL = "gemini-2.5-flash-lite-preview-tts";
...
function formatCustomPronunciations(customPronunciations) {
  if (!(customPronunciations == null ? void 0 : customPronunciations.pronunciations.length)) {
    return void 0;
  }
  const rules = customPronunciations.pronunciations.map((pronunciation) => {
    const encoding = pronunciation.phoneticEncoding ? ` using ${pronunciation.phoneticEncoding}` : "";
