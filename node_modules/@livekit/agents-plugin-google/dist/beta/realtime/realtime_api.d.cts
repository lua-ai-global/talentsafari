...
export declare class RealtimeSession extends llm.RealtimeSession {
    ...
    private toolCallStatuses;
    private toolResponseCallIds;
    private generationPendingTurnComplete?;
    constructor(realtimeModel: RealtimeModel);
    private closeActiveSession;
    private markRestartNeeded;
    private isNonBlockingToolBehavior;
    private shouldBlockRealtimeInputForPendingTools;
    ...
    private clearPendingToolCallIdsForResponses;
