...
function makeIntegrationSpeech() {
  ...
  const resampler = new AudioResampler(sampleRate, 24e3, channels);
...
describe("ElevenLabs STT integration", () => {
  it.skipIf(!hasElevenLabsApiKey)(
    ...
    async () => {
      ...
      expect(wordErrorRate(((_b = (_a = event.alternatives) == null ? void 0 : _a[0]) == null ? void 0 : _b.text) ?? "", TRANSCRIPT)).toBeLessThanOrEqual(
        0.25
      );
    },
    6e4
...
describe("ElevenLabs STT", () => {
  ...
  it("sends batch recognition form fields and maps word metadata", async () => {
    ...
    try {
      ...
      expect(request == null ? void 0 : request.method).toBe("POST");
      expect(request == null ? void 0 : request.url).toBe("/speech-to-text");
      expect(request == null ? void 0 : request.apiKey).toBe("test-key");
      expect(request == null ? void 0 : request.body).toContain('name="model_id"');
      expect(request == null ? void 0 : request.body).toContain("scribe_v2");
      expect(request == null ? void 0 : request.body).toContain('name="tag_audio_events"');
      expect(request == null ? void 0 : request.body).toContain("false");
      expect(request == null ? void 0 : request.body).toContain('name="language_code"');
      expect(request == null ? void 0 : request.body).toContain("fr");
      expect(request == null ? void 0 : request.body.match(/name="keyterms"/g)).toHaveLength(2);
      expect(event.type).toBe(sttLib.SpeechEventType.FINAL_TRANSCRIPT);
      expect((_a = event.alternatives) == null ? void 0 : _a[0]).toMatchObject({
        text: "bonjour livekit",
        language: "fr",
        speakerId: "speaker-a",
        startTime: 0.2,
      ...
      expect((_d = (_c = (_b = event.alternatives) == null ? void 0 : _b[0]) == null ? void 0 : _c.words) == null ? void 0 : _d.map((word) => word.text)).toEqual([
        "bonjour",
        "livekit"
      ]);
    } finally {
  ...
  it("streams audio and maps realtime speech events", async () => {
    ...
    try {
      ...
      expect(typeof ((_a = receivedMessages[0]) == null ? void 0 : _a.audio_base_64)).toBe("string");
      ...
      expect((_c = (_b = speechEvents[2]) == null ? void 0 : _b.alternatives) == null ? void 0 : _c[0]).toMatchObject({
        text: "hello",
        language: "en",
        startTime: 1.1,
        endTime: 1.4
      });
      expect((_g = (_f = (_e = (_d = speechEvents[2]) == null ? void 0 : _d.alternatives) == null ? void 0 : _e[0]) == null ? void 0 : _f.words) == null ? void 0 : _g[0]).toMatchObject({
        text: "hello",
        startTime: 1.1,
        endTime: 1.4,
        startTimeOffset: 1
  ...
  it("builds realtime query params for language, timestamps, and server VAD", async () => {
    ...
    try {
      ...
      expect(
        (_c = (_b = (_a = events.find((event) => event.type === sttLib.SpeechEventType.FINAL_TRANSCRIPT)) == null ? void 0 : _a.alternatives) == null ? void 0 : _b[0]) == null ? void 0 : _c.text
      ).toBe("kept");
    } finally {
      await closeWebSocketServer(wss);
    }
