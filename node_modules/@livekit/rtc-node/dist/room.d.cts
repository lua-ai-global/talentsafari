import { RoomInfo, ConnectionQuality, DataPacketKind, EncryptionType, ConnectionState, DisconnectReason, IceTransportType, ContinualGatheringPolicy, IceServer, SimulateScenarioKind, RoomOptions as RoomOptions$1 } from '@livekit/rtc-ffi-bindings';
import { TypedEventEmitter } from '@livekit/typed-emitter';
import { g as TextStreamHandler, f as ByteStreamHandler } from './stream_reader-CuG4b8Y-.cjs';
