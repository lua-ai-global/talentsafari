...
const defaultE2EEOptions = {
  ...
  encryptionType: import_rtc_ffi_bindings.EncryptionType.GCM
};
class KeyProvider {
  /** internal */
  ...
  setSharedKey(sharedKey, keyIndex) {
    const req = new import_rtc_ffi_bindings.E2eeRequest({
      roomHandle: this.roomHandle,
      message: {
        case: "setSharedKey",
        value: new import_rtc_ffi_bindings.SetSharedKeyRequest({
          keyIndex,
          sharedKey
        })
      }
  ...
  exportSharedKey(keyIndex) {
    const req = new import_rtc_ffi_bindings.E2eeRequest({
      ...
      message: {
        case: "getSharedKey",
        value: new import_rtc_ffi_bindings.GetSharedKeyRequest({
          keyIndex
        })
      }
    });
  ...
  ratchetSharedKey(keyIndex) {
    const req = new import_rtc_ffi_bindings.E2eeRequest({
      ...
      message: {
        ...
        value: new import_rtc_ffi_bindings.RatchetSharedKeyRequest({
          keyIndex
        })
      }
    });
  ...
  setKey(participantIdentity, keyIndex) {
    const req = new import_rtc_ffi_bindings.E2eeRequest({
      ...
      message: {
        case: "setKey",
        value: new import_rtc_ffi_bindings.SetKeyRequest({
          keyIndex,
          participantIdentity
        })
      }
  ...
  exportKey(participantIdentity, keyIndex) {
    const req = new import_rtc_ffi_bindings.E2eeRequest({
      ...
      message: {
        case: "getKey",
        value: new import_rtc_ffi_bindings.GetKeyRequest({
          keyIndex,
          participantIdentity
        })
      }
  ...
  ratchetKey(participantIdentity, keyIndex) {
    const req = new import_rtc_ffi_bindings.E2eeRequest({
      ...
      message: {
        case: "ratchetKey",
        value: new import_rtc_ffi_bindings.RatchetKeyRequest({
          keyIndex,
          participantIdentity
        })
      }
  ...
  setEnabled(enabled) {
    ...
    const req = new import_rtc_ffi_bindings.E2eeRequest({
      ...
      message: {
        ...
        value: new import_rtc_ffi_bindings.FrameCryptorSetEnabledRequest({
  ...
  setKeyIndex(keyIndex) {
    ...
    const req = new import_rtc_ffi_bindings.E2eeRequest({
      ...
      message: {
        ...
        value: new import_rtc_ffi_bindings.FrameCryptorSetKeyIndexRequest({
          participantIdentity: this.participantIdentity,
  ...
  setEnabled(enabled) {
    ...
    const req = new import_rtc_ffi_bindings.E2eeRequest({
      ...
      message: {
        ...
        value: new import_rtc_ffi_bindings.E2eeManagerSetEnabledRequest({
          enabled: this.enabled
        })
      }
    });
