...
var AudioResamplerQuality = ((AudioResamplerQuality2) => {
  AudioResamplerQuality2[AudioResamplerQuality2["QUICK"] = import_rtc_ffi_bindings.SoxQualityRecipe.SOXR_QUALITY_QUICK] = "QUICK";
  AudioResamplerQuality2[AudioResamplerQuality2["LOW"] = import_rtc_ffi_bindings.SoxQualityRecipe.SOXR_QUALITY_LOW] = "LOW";
  AudioResamplerQuality2[AudioResamplerQuality2["MEDIUM"] = import_rtc_ffi_bindings.SoxQualityRecipe.SOXR_QUALITY_MEDIUM] = "MEDIUM";
  AudioResamplerQuality2[AudioResamplerQuality2["HIGH"] = import_rtc_ffi_bindings.SoxQualityRecipe.SOXR_QUALITY_HIGH] = "HIGH";
  AudioResamplerQuality2[AudioResamplerQuality2["VERY_HIGH"] = import_rtc_ffi_bindings.SoxQualityRecipe.SOXR_QUALITY_VERYHIGH] = "VERY_HIGH";
...
class AudioResampler {
  ...
  constructor(inputRate, outputRate, channels = 1, quality = AudioResamplerQuality.MEDIUM) {
    ...
    const req = new import_rtc_ffi_bindings.NewSoxResamplerRequest({
      inputRate,
      outputRate,
      numChannels: channels,
      qualityRecipe: quality,
      inputDataType: import_rtc_ffi_bindings.SoxResamplerDataType.SOXR_DATATYPE_INT16I,
      outputDataType: import_rtc_ffi_bindings.SoxResamplerDataType.SOXR_DATATYPE_INT16I,
      flags: 0
    });
   ...
   */
  push(data) {
    const req = new import_rtc_ffi_bindings.PushSoxResamplerRequest({
   ...
   */
  flush() {
    const req = new import_rtc_ffi_bindings.FlushSoxResamplerRequest({
      resamplerHandle: this.#ffiHandle.handle
    });
    const res = import_ffi_client.FfiClient.instance.request({
      message: {
