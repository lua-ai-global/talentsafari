...
const abandonedBasketProcessorJob = new LuaJob({
  ...
  execute: async () => {
        ...
        if (isAbandoned) {
          ...
          if (reminder.data.phoneNumber && WHATSAPP_CHANNEL_ID) {
            try {
              ...
              const template = templatesResponse.templates.find((t) => t.status === 'APPROVED');
    ...
    console.log(
      `📊 Processed: ${processedCount}, Abandoned: ${abandonedCount}, Checked out: ${checkedOutCount}, Messages sent: ${messagesSent}`
    );
